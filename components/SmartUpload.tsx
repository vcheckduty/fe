...
export default function SmartUpload({ onImageSelect, onCheckLocation }: SmartUploadProps) {
          ...
          {isMobile ? (
            <>
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 font-semibold rounded-lg transition-colors shadow-sm bg-blue-600 text-white hover:bg-blue-700"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
